<div class="pt-2 relative text-gray-300 mb-8 mx-4">
    <input wire:model="query" class="shadow bg-white h-10 px-5 pr-16 rounded-full text-sm focus:outline-none w-full" type="search" name="search" placeholder="Zoek een klant...">
