<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    <div>
        <img class="w-52" src="/storage/logo/klusmin.png" alt="Logo klusminuten">
    </div>

    <div class="mt-8 text-2xl">
        Welkom bij de klusminuten app
    </div>

    <div class="mt-6 text-gray-500">
        Dit is de testwebsite van klusminuten, hierop hebben we de demo versie van de app draaien. 
    </div>
</div>
